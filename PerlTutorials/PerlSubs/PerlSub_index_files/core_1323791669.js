...
return s;},removeSWF:function(obj)
{if(obj)
...
element=parentTag.firstChild||null;if(!element){element=documentContext.createElement(tagName);var classAdded=false;for(var attr in attrs)
{try
...
return $iTXT.core.$(element);},_children:function(element,children,documentContext,allowUnsafe)
