...
{try
{$iTXT.debug.debug($iTXT.debug.Category.FLASH,"Calling Flash method <b>'."+opts.method+"()' for "+this.options.id+"MC");if(!opts.param)
{flmc[opts.method]();}
else
...
{$iTXT.core.Util.removeSWF(flash);this.rootElement.itxtClear();}
