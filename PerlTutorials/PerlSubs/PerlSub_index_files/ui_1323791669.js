...
this.rootElement.mask.itxtHide();this.rootElement.itxtHide();document.body.appendChild(this.rootElement);document.body.appendChild(this.rootElement.mask);}},fixOpacity:function()
...
{for(var f=0,fLen=flashes.length;i<fLen;f++)
...
{var thisAttr=thisFlash.attributes[a];if(thisAttr&&thisAttr.nodeValue&&allowedWmode[thisAttr.nodeValue])
{isAttrWmode=true;}}}
...
{var flash=document.getElementById("lboxTakoverMC");if(flash)
{try
{flash.muteVideo();flash.reset();}
catch(e)
{}}
this.rootElement.mask.itxtHide();this.rootElement.iframe.itxtHide();this.rootElement.itxtHide();}});}
...
{var src=(e.target==this.hookIcon)?$iTXT.data.ClickSource.ICON:$iTXT.data.ClickSource.KEYWORD;$iTXT.core.$(document).itxtFire("$iTXT:hook:click",{source:src,hookid:this.options.id,hook:this,advert:this.ad});return false;},setState:function(s)
...
{var adParams=e.data.hook.ad.params;var ittc=adParams.getBool("tt.stop.pending.open",adParams.getBool("ittc",0));if(ittc)
